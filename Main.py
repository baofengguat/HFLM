...
weights_path=os.path.join(current_dir,r'l2t_ww\resnet18-5c106cde.pth')
weights_path1=os.path.join(current_dir,r'l2t_ww\vgg16-397923af.pth')
...
def init_meta_model(opt,pairs,server_model,local_nets):
    ...
    return wnets,lwnets,wlw_weight_params,target_params_dict,target_branch_dict
...
def init_nets(args, device='cpu',server=False):
    ...
    #args.model=args.source_model if args.source_model== args.target_model else None
